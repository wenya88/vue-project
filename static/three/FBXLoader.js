...
( function () {
	...
	function parseTexture( textureNode, loader, images, connections ) {
		...
		texture.RelativeFilename = textureNode.RelativeFilename;
		// console.log(texture);
	...
	function genGeometry( FBXTree, geoNode, skeleton, morphTarget, preTransform ) {
		...
		if(buffers.faceLength)
		{
			geo.addAttribute( 'faceLength', buffers.faceLength );
			geo.addAttribute( 'vertsLenght', (geoNode.Vertices.a.length/3) );
		}
