    ...
    <div class="projectChartBox">
        ...
        <div class="projectChart" id="range">
            <div class="dataSelet">
                ...
                <div :class="[nIndex==index?'span showSpan':'span']" v-for="(item,index) in dateList" @click="changeDate(item.type,index)">{{ item.val }}</div>
                <div class="clear"></div>
            </div>
                    ...
                    <div class="chartFloat" :style="`width:${Math.abs(item.total_day)*20+'px'}`">
                        ...
                        <div class="projectInfo">
                            ...
                            <div v-else class="infoHidden">
                                <Tooltip :content="item|fileContent" placement="right">
