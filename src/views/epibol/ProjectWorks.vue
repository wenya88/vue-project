      ...
      <Row class="page_group_row">
        <Col span='16' class="group_left">
           ...
           <div class="group_left_main">
              <div class="group_main_msg" id="testTaskDiv" @click="clickTestTask($event)">
                  <span class="group_head_title">我的测试任务</span>
                  <span class="open_botton iconfont"></span>
                  <div class="close_box">
                      <div class="close_box_child">
                          <div class="close_box_left">
                              <Progress :percent="testTaskObj.complatTaskNum/testTaskObj.testTaskNum*100" :stroke-width="10" hide-info status="success">
                              </Progress>
                          </div>
                          <div class="close_box_right">
                              <!-- <p class="close_popress_msg">进度</p> -->
                              <p class="close_popress_num"><span>{{testTaskObj.complatTaskNum}}</span>/<span>{{testTaskObj.testTaskNum}}</span></p>
                          </div>
                      </div>
                  </div>
              </div>
        ...
        <Col span='8' class="tables_all_father">
         <div class="tables_all">
            <Tabs :value="tabname" v-if="TaskTab" @on-click="getTab">
            ...
            <Tabs :value="tabname" v-if="testTaskTab" @on-click="getTab">
                <TabPane :label="testTaskNowDay" name="name1">
                    <project-task :list="testTaskObj.nowDayList" :isTest="true"></project-task>
                </TabPane>
                <TabPane :label="testTaskdelay" name="name2">
                    <project-task :list="testTaskObj.delayList" :isTest="true"></project-task>
                </TabPane>
                <TabPane :label="testTaskNo" name="name3">
                    <project-task :list="testTaskObj.NoList" :isTest="true"></project-task>
                </TabPane>
            </Tabs>
         </div>
        </Col>
    ...
    async getAuditTestTaskList(){
        ...
        if(TestTaskList.data.err_code == 0){
            ...
            for(let i=0;i<dataArr.length;i++){
                ...
                // console.log(JSON.stringify(this.testTaskObj))
            }
        }else {
