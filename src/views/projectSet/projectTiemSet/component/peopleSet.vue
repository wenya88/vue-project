<template>
    <div>
        <main-native>
            <div class="main-header-style iconfont"><span class="main-header-title"><i
                    v-if="!islink"></i>{{this.$route.meta.title}}</span></div>
        </main-native>
                    ...
                    <template v-if="memberArray">
                        <li class="cardBox" v-for="(item,index) in memberArray" :key="index">
                            <div class="card">
                                ...
                                <p>{{item.remark_name || 'Null'}}</p>
                            </div>
                            <div class="job">
                                <!--<span>{{item.department_name || 'Null'}}</span>-->
                                <span>{{item.job || '暂无'}}</span>
                            </div>
                ...
                <template v-if="items">
                    <div class="departmentList" v-for="(item,index) in items" :key="index">
                        ...
                        <div class="persionList">
                            <ul>
                                <li v-for="(member,i) in item.members" :key="i" :class="{'activeSty':member.is_join}" :title=" member.remark_name"
                                    @click="onCard(member.member_id)">
                                    <div>
