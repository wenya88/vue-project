<template>
    <div class="subtasksList">
        <section v-for="(items,index) in taskList"  @click="editWindow(items)" :key="index" class="taskList">
            ...
            <div class="info">
                <span>{{items.expect_work_day}}个工作日</span><span><img class="headImg" src="../QQ图片20180719133401.jpg"
                                                                     alt=""><span
...
//                    console.log(111,this.taskList)
        ...
        computed: {
            ...mapState({
                infoId(value){
                    console.log(11, value.project.detail.setDetailAll)
