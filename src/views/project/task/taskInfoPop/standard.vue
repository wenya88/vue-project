        ...
        <dl class="standardList">
            ...
            <template v-if="infoDetails">
                <dd v-for="(item,index) in infoDetails.standard" :key="index" class="standardInfo"
                    v-if="item.type === 'progress' || item.type === 'hand' || item.type === 'connect'"
                >
                    <span>{{item.name}}</span>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            flowChartInit(){
                // console.log(22,this.infoDetails)
                if(this.infoDetails&&this.infoDetails.stage[0]){
                    this.flowChartText  =  this.infoDetails.stage[0].require
                }
            }
        },
        computed: {
