    ...
    <div class="subtask">
        <div style="text-align: right">
            <span v-if="!userStatus" class="addTask" @click="showAccretionTask">
                <Icon style="margin-right: 8px;color: #fcc44a;vertical-align: middle" size="20" type="ios-plus-outline"></Icon>增加子任务
            </span>
        </div>
        <!--列表-->
        <tasklist subtask="true" ref="list" v-on:editWindow="showTaskDetails"></tasklist>
        <!--新增任务组件-->
