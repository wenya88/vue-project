        ...
        function defined(dom){
          ...
          $(document).on("mousedown",dom,function(e){
            ...
            if(e.which==3){
              ...
              $(".editSginDiv").hide();
                ...
                // console.log('YYYYY',e.clientY);
                // console.log('offsetX',$(dom).offset().left);
                // console.log('offsetY',$(dom).offset().top);
          ...
          $(document).on('click','.sureSign',function(){
            if($('.signbox em').length>0){
              ...
              $('#Ts'+indexId).css({"left":cX,"top":cY});
              var mes={left:cX,top:cY,message:text,index:indexId};
