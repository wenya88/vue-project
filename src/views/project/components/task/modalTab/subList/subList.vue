            ...
            <div class="modal">
                <div class="modal-header">
                    ...
                    <Row :gutter="100">
                        ...
                        <Col span="1">
                        <div>
                            <Icon type="ios-trash-outline" size="23"
                                  style="cursor: pointer;position: absolute;z-index: 999999;display: inline-block;"></Icon>
                        </div>
                        </Col>
                        <Col span="2">
                    ...
                    <Tabs type="card">
                        <TabPane label="基本管理">
                            <Form label-position="left" :label-width="80">
                                <FormItem label="任务名称">
                                    <Input v-model="editSubList.name"></Input>
                                </FormItem>
                                <FormItem label="开始时间">
                                    <DatePicker :value="editSubList.expect_start_time" @on-change="handleChange" format="yyyy-MM-dd"
                                                type="date" :options="disableTime"
                                                placeholder="选择时间" style="width: 100%"></DatePicker>
                                </FormItem>
                                <FormItem label="结束时间">
                                    <DatePicker :value="editSubList.expect_end_time" @on-change="handleChange2" format="yyyy-MM-dd"
                                                type="date" :options="disableTime2"
                                                placeholder="选择时间" style="width: 100%"></DatePicker>
                                </FormItem>
                                <FormItem label="子项目">
                                    <Select v-model="editSubList.project">
                                        <Option :value="editSubList.project_child"
                                                :key="editSubList.project_child"></Option>
                                    </Select>
                                </FormItem>
                                <FormItem label="参与人">
                                    <Tag v-for="item in fruit" :key="item.fruit" :name="item" closable
                                                ...
                                                <Scroll :on-reach-bottom="handleReachBottom">
                                                    <div class="tabCon">
                                                        <div
                                                                ...
                                                                v-show="index == num">
                                                            <Card dis-hover>
                                                                <CheckboxGroup v-model="editSubList.fruit">
                                                                    <Checkbox :label="i,d"
                                                                              v-for='(i,d) in itemCon'
                                                                              :key="i.itemCon"></Checkbox>
                                                                </CheckboxGroup>
                                                            </Card>
                                                        </div>
                                                    </div>
                                ...
                                <FormItem label="任务类型">
                                    <Select v-model="editSubList.tasktype_id">
                                        <Option :value="editSubList.tasktype_id"
                                                :key="editSubList.tasktype_id"></Option>
                                    </Select>
                                </FormItem>
                                <FormItem label="文件要求">
                                    <div>
                                ...
                                <FormItem label="要求说明">
                                    <Input v-model="editSubList.description" type="textarea"
