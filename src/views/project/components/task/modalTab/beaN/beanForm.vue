<template>
    <Form label-position="left" :label-width="80">
        ...
        <FormItem label="开始时间">
            <DatePicker :value="editData.expect_start_time" format="yyyy-MM-dd" type="date" :options="disableTime"
                        placeholder="选择时间" style="width: 100%"></DatePicker>
        </FormItem>
        <FormItem label="结束时间">
            <DatePicker :value="editData.expect_end_time" format="yyyy-MM-dd" type="date" :options="disableTime2"
                        placeholder="选择时间" style="width: 100%"></DatePicker>
        </FormItem>
        <FormItem label="子项目">
