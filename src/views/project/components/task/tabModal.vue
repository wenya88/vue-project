                            ...
                            <div>
                                <Row>
                                    ...
                                    <Form label-position="left" :label-width="80">
                                        ...
                                        <FormItem label="开始时间">
                                            <DatePicker :value="editData.expect_start_time" @on-change="handleChange" format="yyyy-MM-dd"
                                                        type="date" :options="disableTime"
                                                        placeholder="选择时间" style="width: 100%"></DatePicker>
                                        </FormItem>
                                        <FormItem label="结束时间">
                                            <DatePicker :value="editData.expect_end_time" @on-change="handleChange2" format="yyyy-MM-dd"
                                                        type="date" :options="disableTime2"
                                                        placeholder="选择时间" style="width: 100%"></DatePicker>
                                        </FormItem>
                                        <FormItem label="子项目">
                                            <Select v-model="editData.dataList">
                                                <Option v-for="item in seleData" :value="item.project"
                                                        :key="item.project"></Option>
                                            </Select>
                                        </FormItem>
                                        <FormItem label="参与人">
                                        ...
                                        <FormItem label="任务类型">
                                            <Select v-model="editData.dataList">
                                                <Option v-for="item in seleData" :value="item.tasktype_name"
                                                        :key="item.tasktype_name"></Option>
                                            </Select>
                                        </FormItem>
                                        <FormItem label="文件要求">
                                            <div>
                                        ...
                                        <FormItem label="要求说明">
                                            <Input v-model="editData.name" type="textarea"
