                            ...
                            <Form label-position="left" :label-width="80">
                                ...
                                <FormItem label="子项目">
                                    <Select v-model="addData.project">
                                        <Option v-for="(item,index) in addData.project_id" :value="item.project_id" :key="item.project_id">{{item.name}}</Option>
                                    </Select>
                                </FormItem>
                                <FormItem label="参与人">
                                ...
                                <FormItem label="任务类型">
                                    <Select v-model="addData.tasktype_id">
                                        <Option :value="addData.tasktype_id" :key="addData.tasktype_id"></Option>
                                    </Select>
                                </FormItem>
                                <FormItem label="文件要求">
                                    <div>
...
export default {
  ...
  */
        ...
        getforEachChild() {
            let cHd = this;
            this.get(getChildList,
                {
                    id: cHd.childId
                },
                (res) => {
                    cHd.formLeft = res.data;
                    console.log(cHd.formLeft);
                }
            );
        },
    }
