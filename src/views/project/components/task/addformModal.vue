        ...
        <div class="modal-backdrop">
            <div class="modal smallModal">
                <div class="modal-header">
                    <slot name="header">
                        <div><h2 style="color: #2b85e4;">基本管理</h2></div>
                    ...
                    <div>
                        <Row>
                            ...
                            <Form label-position="left" :label-width="80">
                                ...
                                <FormItem label="开始时间">
                                    <DatePicker :value="addData.expect_start_time" @on-change="handleChange" format="yyyy-MM-dd" type="date"
                                                :options="disableTime"
                                                placeholder="选择时间" style="width: 100%"></DatePicker>

                                </FormItem>
                                <FormItem label="结束时间">
                                    <DatePicker :value="addData.expect_end_time" @on-change="handleChange2" format="yyyy-MM-dd" type="date"
                                                :options="disableTime2"
                                                placeholder="选择时间" style="width: 100%"></DatePicker>
                                </FormItem>
                                <FormItem label="子项目">
                                    <Select v-model="addData.project">
                                        <Option :value="addData.project_child"
                                                :key="addData.project_child"></Option>
                                    </Select>
                                </FormItem>
                                <FormItem label="参与人">
                                ...
                                <FormItem label="任务类型">
                                    <Select v-model="addData.tasktype_id">
                                        <Option :value="addData.tasktype_id"
                                                :key="addData.tasktype_id"></Option>
                                    </Select>
                                </FormItem>
                                <FormItem label="文件要求">
                                    <div>
                                ...
                                <FormItem label="要求说明">
                                    <Input v-model="addData.description" type="textarea"
