<template>
    <div>
        <div class="videoM">
            ...
            <!--操作按钮-->
            <div class="canvasEdit" v-if="userPost.postId != '3'">
            ...
            <feedback-Info ref="feedback" v-if="fileId" v-on:commitEidt="commitEidt" :fileId="fileId" :testData="testData"></feedback-Info>
            <feedback-Info ref="feedback" v-else v-on:commitEidt="commitEidt" :testData="testData"></feedback-Info>
