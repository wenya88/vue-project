<template>
  <div class="qualityContainer" id="completed">
    ...
    <div class="nav">
      ...
      <div  v-if="companyType == 0 && projectSet.qualitySecond" class="second" @click="resourcesData(1)">
        <i-circle
          :size="120"
          :trail-width="0"
          :stroke-width="13"
      ...
      <div  v-if="companyType == 0 && projectSet.qualityThird" class="third" @click="resourcesData(3)">
        <i-circle
          :size="120"
          :trail-width="0"
          :stroke-width="13"
      ...
      <div  v-if="projectSet.qualityFourth" class="fourth" @click="resourcesData(2)">
        ...
        <p v-if="companyType == 1" class="description">待确认</p>
        <p v-else class="description">客户待审</p>
      </div>
      <div  v-if="projectSet.qualityFifth" class="fifth" @click="resourcesData(4)">
        ...
        <p v-if="companyType == 1" class="description">已反馈</p>
        <p v-else class="description">客户已反馈</p>
      </div>
    </div>
