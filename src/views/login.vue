...
//    var jsencrypt = require('jsencrypt');
    ...
    export default {
        ...
        methods: {
            ...
            async onSubmit() {
                const publicKey = await this.$axios.get(this.GLOBAL.baseRouter + 'system/login/get-public-secret-key');
                this.publicKey = publicKey.data.public_key;
                let encrypt = new JSEncrypt();
                encrypt.setPublicKey(this.publicKey);
